...
SWIFT_CLASS("_TtC20TealiumTagManagement29TealiumTagManagementUIWebView")
@interface TealiumTagManagementUIWebView : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class UIWebView;

@interface TealiumTagManagementUIWebView (SWIFT_EXTENSION(TealiumTagManagement)) <UIWebViewDelegate>
...
SWIFT_CLASS("_TtC20TealiumTagManagement29TealiumTagManagementWKWebView") SWIFT_AVAILABILITY(ios,introduced=11.0)
@interface TealiumTagManagementWKWebView : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface TealiumTagManagementWKWebView (SWIFT_EXTENSION(TealiumTagManagement)) <WKHTTPCookieStoreObserver>
...
SWIFT_AVAILABILITY(ios,introduced=11.0)
@interface TealiumTagManagementWKWebView (SWIFT_EXTENSION(TealiumTagManagement)) <WKNavigationDelegate>
/// Called when the WebView has finished loading a resource (DOM Complete)
